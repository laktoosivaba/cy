...
typedef struct cy_wasm_tx_t     cy_wasm_tx_t;
typedef struct cy_wasm_rpc_rx_t cy_wasm_rpc_rx_t;
...
struct cy_wasm_topic_t
{
    ...
    void (*rx_sock_err_handler)(cy_wasm_t* cy_udp, cy_wasm_topic_t* topic, uint_fast8_t iface_index, uint32_t err_no);
};
...
struct cy_wasm_t
{
    ...
    uint32_t response_extent_with_overhead;
    ...
    cy_wasm_tx_t     tx[CY_UDP_POSIX_IFACE_COUNT_MAX];
    cy_wasm_rpc_rx_t rpc_rx[CY_UDP_POSIX_IFACE_COUNT_MAX];
    ...
    void (*rx_sock_err_handler)(cy_wasm_t* cy_wasm, cy_wasm_topic_t* topic, uint_fast8_t iface_index, uint32_t err_no);
 ...
 */
// cy_err_t cy_wasm_init(cy_wasm_t* const cy_wasm, const uint64_t uid);
//
// cy_err_t cy_wasm_new(cy_wasm_t* const cy_wasm, const uint64_t uid);
